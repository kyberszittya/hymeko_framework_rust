...
#
# SYNC from the Mac (run there, when kato15 is reachable):
#   tar czf - hymeko_rl/experiments/exp_sac_walk_campaign.py hymeko_rl/experiments/exp_sac_walk_validation.py \
#     hymeko_rl/experiments/exp_aibo_cip_walk.py hymeko_rl/env/locomotion_env.py hymeko_rl/env/locomotion_experts.py \
#     hymeko_rl/env/reward.py hymeko_rl/env/terrain.py hymeko_rl/env/track_gen.py data/robotics/*.hymeko \
#     scripts/kato15/run_sac_walk.sh \
#   | ssh kato15 'bash -lc "cd ~/hymeko_framework_rust && tar xzf -"'
#
# RUN on kato15:   bash scripts/kato15/run_sac_walk.sh [smoke|full]
set -euo pipefail
