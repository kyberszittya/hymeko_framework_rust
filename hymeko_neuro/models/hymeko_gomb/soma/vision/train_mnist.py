...
Run via the orchestrator script:
    hymeko_neuro/experiments/run_gomb_soma_mnist_bench_2026_05_14.sh
"""
...
def load_cluttered(n_train: int, n_test: int, batch_size: int, seed: int,
    ...
    from hymeko_neuro.experiments.vision.cluttered_classification import (
...
def build_model(model_type: str, device: torch.device,
    ...
    if model_type == "gomb_soma":
        ...
        from hymeko_neuro.models.hymeko_gomb.soma.hg_conv import Aggregation
        m = WalkConvImageClassifier(
            image_h=image_h, image_w=image_w, patch_size=4,
            in_channels=1, d_hidden=16, n_classes=10,
        ...
        from hymeko_neuro.models.hymeko_gomb.soma.hg_conv import MessageActivation
        ...
        # See hymeko_neuro/.../soma/vision/holonomy_walk.py.
