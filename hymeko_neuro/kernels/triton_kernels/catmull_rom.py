"""Auto-split from hymeko_neuro/kernels/triton_kernels.py 2026-05-11.
...
def catmull_rom_triton(
    ...
    # over per-row coef.
    if coef.dim() != 2:
        from hymeko_neuro.hyperedge.splines import _catmull_rom_eval as _ref
...
def install_triton_catmull_rom():
    ...
    """
    from hymeko_neuro.hyperedge import splines
