...
Usage:
    ...
    python -m hymeko_neuro.hymeko.hymeko_driver \\
...
def run_single(
    ...
    *,
    ...
    Routes through `hymeko_neuro.experiments.runs.run_final_cell.cell_signed_graph`,
...
def run_single_gomb(
    ...
    *,
    ...
    from hymeko_neuro.experiments.gomb_pgraph_mapping import smoke_argv_from_knobs
