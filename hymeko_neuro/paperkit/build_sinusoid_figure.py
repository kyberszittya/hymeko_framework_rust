...
Produces ``hymeko_neuro/assets/paper/figures/sinusoid_distillation.pdf``.
"""
...
from hymeko_neuro.experiments.runs.run_compare import build_edge_incidence
from ..core.prune_distill import (measure_activity, sample_spline_activation,
                             fit_symbolic, evaluate_symbolic,
                             SYMBOLIC_LIBRARY)

REPO = Path(__file__).resolve().parents[2]
FIG  = REPO / "hymeko_neuro" / "paper" / "figures" / "sinusoid_distillation.pdf"
