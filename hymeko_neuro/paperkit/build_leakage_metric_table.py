...
Emits markdown + Springer-ready LaTeX tables (booktabs) to hymeko_neuro/assets/paper/tables/. No experiments
-- pure aggregation of the committed JSONL. Run:
    uv run python -m hymeko_neuro.paperkit.build_leakage_metric_table
    uv run python -m hymeko_neuro.paperkit.build_leakage_metric_table --self-check
"""
...
_RESULTS = Path("hymeko_neuro/experiments/results")
_OUT = Path("hymeko_neuro/assets/paper/tables")
