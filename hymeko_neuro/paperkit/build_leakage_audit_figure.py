...
``hymeko_neuro/assets/paper/figures/leakage_audit.{pdf,png,eps}`` (EPS for Springer).

Run:
  python -m hymeko_neuro.paperkit.build_leakage_audit_figure \
      [--input hymeko_neuro/experiments/results/no_leak_baselines.jsonl]
"""
...
DEFAULT_INPUT = REPO / "hymeko_neuro" / "experiments" / "results" / "no_leak_baselines.jsonl"
