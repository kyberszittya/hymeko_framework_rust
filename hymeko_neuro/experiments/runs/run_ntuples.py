...
Usage::
    ...
    python -m hymeko_neuro.experiments.runs.run_ntuples \\
...
from hymeko_neuro.hyperedge.n_tuples import construct_k, stats as ntuple_stats
from hymeko_neuro.hyperedge.signedkan import (MultiLayerSignedKAN, MultiLayerSignedKANConfig,
...
def main():
    ...
    ap.add_argument("--out", default=
                    "hymeko_neuro/experiments/results/ntuples.json")
    args = ap.parse_args()
