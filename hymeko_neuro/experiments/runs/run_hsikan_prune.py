...
from hymeko_neuro.hyperedge.highway_signedkan import HighwaySignedKAN, HighwaySignedKANConfig
from hymeko_neuro.hyperedge.signedkan import build_vertex_triad_incidence
...
from hymeko_neuro.hyperedge.prune_distill import (measure_activity, prune_inactive,
...
def main():
    ...
    ap.add_argument("--out", default=
                    "hymeko_neuro/experiments/results/hsikan_prune.json")
    args = ap.parse_args()
