...
the gap on CPU and CUDA (median / IQR / worst over warmed-up runs).
    ...
    python -m hymeko_neuro.experiments.runs.bench_spatial_pyramid
"""
...
from hymeko_neuro.experiments.vision.spatial_pyramid import SpatialPyramidPool, grid_positions
