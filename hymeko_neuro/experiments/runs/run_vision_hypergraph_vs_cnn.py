...
-----
    PYTHONPATH=$PWD systemd-run --user --scope -p MemoryMax=16G \\
        ...
        hymeko_neuro.experiments.runs.run_vision_hypergraph_vs_cnn \\
...
from hymeko_neuro.experiments.runs.run_regime_abc_5seed import _mean_sd
from hymeko_neuro.experiments.vision.vision_bench_cell import DATASETS, MODEL_NAMES

CELL_MODULE = "hymeko_neuro.experiments.vision.vision_bench_cell"
