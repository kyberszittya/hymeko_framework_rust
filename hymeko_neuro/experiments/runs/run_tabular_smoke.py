...
Run:
    python -m hymeko_neuro.experiments.runs.run_tabular_smoke
"""
...
from hymeko_neuro.hyperedge.n_tuples import construct_2, construct_k
from hymeko_neuro.data.tabular_signed_graph import build_signed_graph_from_tabular
