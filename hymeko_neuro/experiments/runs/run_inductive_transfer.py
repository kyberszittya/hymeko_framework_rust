...
One file, mode arg (§6.5 #13):
    python -m hymeko_neuro.experiments.runs.run_inductive_transfer --smoke
    python -m hymeko_neuro.experiments.runs.run_inductive_transfer --full
"""
...
from hymeko_neuro.baselines.registry import GraphMeta, HParams, get_baseline
...
def main(smoke: bool = True, out_path: Any = None,
    ...
    out_path = out_path or (
        f"hymeko_neuro/experiments/results/inductive_transfer_"
...
def main_decomp(out_path: Any = None, seeds: tuple[int, ...] | None = None,
    ...
    out_path = out_path or (
        "hymeko_neuro/experiments/results/inductive_transfer_decomp_hard.jsonl")
