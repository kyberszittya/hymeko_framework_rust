...
Run:
  python -m hymeko_neuro.experiments.runs.run_early_stop

Migrated to the :class:`SimpleExperiment` pattern on 2026-05-19
(Slice H pilot of the hymeko_neuro reorganisation). The script
...
def main() -> None:
    ...
    ap.add_argument("--out", default=
                    "hymeko_neuro/experiments/results/early_stop.json")
    args = ap.parse_args()
