...
Output: hymeko_neuro/experiments/results/master_table.md
"""
...
SOURCES = [
    ("phase6", "hymeko_neuro/experiments/results/phase6_small_synth.json"),
    ("phase7_15k", "hymeko_neuro/experiments/results/phase7_slashdot.json"),
    ("phase7_100k", "hymeko_neuro/experiments/results/phase7_slashdot_5seed_k3_100k.json"),
    ("phase7_200k", "hymeko_neuro/experiments/results/phase7_slashdot_5seed_k3_200k.json"),
    ("phase8", "hymeko_neuro/experiments/results/phase8_bitcoin_5seed.json"),
    ("phase9", "hymeko_neuro/experiments/results/phase9_k345_mixed.json"),
]
...
def main():
    ...
    out_path = Path("hymeko_neuro/experiments/results/master_table.md")
