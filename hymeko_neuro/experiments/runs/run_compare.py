...
Run:
    python -m hymeko_neuro.experiments.runs.run_compare \\
...
from hymeko_neuro.hyperedge.hyperedges import construct
from hymeko_neuro.hyperedge.signedkan import (SignedKAN, SignedKANConfig,
                         MultiLayerSignedKAN, MultiLayerSignedKANConfig,
                         build_vertex_triad_incidence)
from hymeko_neuro.baselines.vanilla_kan import VanillaKAN
...
from hymeko_neuro.hyperedge.train import build_edge_to_triads
...
from hymeko_neuro.hyperedge.triad_loss import TriadLoss, TriadLossConfig, build_triad_pairs
from hymeko_neuro.hyperedge.n_tuple_loss import (NTupleBalanceLoss, NTupleBalanceLossConfig,
                            build_ntuple_balance_tensors)
from hymeko_neuro.hyperedge.signed_laplacian import make_spectral_init
from hymeko_neuro.hyperedge.cross_branch_reg import CrossBranchRegulariser, CrossBranchRegConfig
from hymeko_neuro.hyperedge.attention import (SignedTriadAttention, attention_entropy_loss,
                          build_attention_pairs)
from hymeko_neuro.hyperedge.participation_reg import (ParticipationRegulariser, triad_degree,
...
def run_one(model_name: str, dataset: str, hidden: int, seed: int,
    ...
    from hymeko_neuro.hyperedge.side_signedkan import StackedSideSignedKAN as _SSK
...
def main():
    ...
    ap.add_argument("--out",
                    default="hymeko_neuro/experiments/results/compare.json")
    args = ap.parse_args()
