...
Output: hymeko_neuro/experiments/results/sinusoid_controls.json
...
from hymeko_neuro.hyperedge.prune_distill import (
    distill_activation,
    fit_summary,
    fit_symbolic,
...
def main():
    ...
    ap.add_argument("--out", default=
                    "hymeko_neuro/experiments/results/sinusoid_controls.json")
    args = ap.parse_args()
