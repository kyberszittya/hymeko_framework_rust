...
Running:
    HSIKAN_TORCH_COMPILE=1 python -m hymeko_neuro.experiments.runs.run_multi_domain_perf_deep

Output:
    hymeko_neuro/experiments/results/multi_domain_perf_deep.json
"""
...
def main():
    ...
    out_path = Path("hymeko_neuro/experiments/results/multi_domain_perf_deep.json")
