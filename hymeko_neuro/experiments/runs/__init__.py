...
These were moved here from ``hymeko_neuro/`` on 2026-05-19
...
Invocation pattern (after the move):
    ...
    python -m hymeko_neuro.experiments.runs.run_gomb_smoke --device cpu
    python -m hymeko_neuro.experiments.runs.run_hsikan_optuna_chase ...

The old invocation path
(``python -m hymeko_neuro<dot>src<dot>run_X args``, with ``<dot>``
