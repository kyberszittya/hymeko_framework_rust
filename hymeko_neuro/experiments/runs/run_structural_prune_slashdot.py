...
Usage:
    HSIKAN_TORCH_COMPILE=1 python -m hymeko_neuro.experiments.runs.run_structural_prune_slashdot

Output:
    hymeko_neuro/experiments/results/structural_prune_slashdot_sota.json
"""
...
from hymeko_neuro.hyperedge.entropy_reg import SplineSmoothRegulariser
