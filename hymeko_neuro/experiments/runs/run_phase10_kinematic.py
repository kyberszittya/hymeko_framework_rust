...
from hymeko_neuro.experiments.kinematic import write_fixture, _serial_arm_urdf
        ...
        for name, count in n_each.items():
            for i in range(count):
                ...
                if name.startswith("serial_"):
                    ...
                    from hymeko_neuro.experiments.kinematic import _serial_arm_urdf
                    import tempfile
...
def main():
    ...
    import hymeko_neuro.experiments.runs.run_phase2_mixed_arity as _rp
    _rp.load = _load
