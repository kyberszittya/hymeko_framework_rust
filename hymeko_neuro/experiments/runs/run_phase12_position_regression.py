...
from hymeko_neuro.experiments.kinematic import _serial_arm_urdf, write_fixture
from hymeko_neuro.experiments.kinematic import urdf_to_signed_graph
...
class CPMLPose(nn.Module):
    ...
    def __init__(self, n_nodes_max: int, arity: int,
        ...
        from hymeko_neuro.hyperedge.cpml import (
            CPML,
            CPMLConfig,
            TierSpec,
        )
