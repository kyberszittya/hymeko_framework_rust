...
:mod:`hymeko_neuro.experiments.voc_pgraph_mapping`, and (with ``--train``)
...
def _run_one_voc_seed(*, seed: int, kw: dict[str, Any]) -> dict[str, Any]:
    ...
    cmd = [
        sys.executable, "-m", "hymeko_neuro.experiments.vision.train_voc_stagec",
        "--year",       kw["year"],
...
def main() -> None:
    ...
    from hymeko_neuro.experiments.voc_pgraph_mapping import (
