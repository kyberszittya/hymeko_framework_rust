...
Quick smoke (CPU OK for small synthetic graphs):
    python -m hymeko_neuro.experiments.runs.run_synthetic_baseline \\
        --generator easy_sbm --n-epochs 30
    HSIKAN_SPARSE_ATTN_K=8 python -m hymeko_neuro.experiments.runs.run_synthetic_baseline \\
...
from hymeko_neuro.data.synthetic_signed_graphs import GENERATORS
