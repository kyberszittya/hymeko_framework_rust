#!/usr/bin/env bash
# Wait until no ``python -m hymeko_neuro.experiments.runs.run_optuna_search`` jobs are
...
#
# Usage:
#   ./hymeko_neuro/experiments/wait_until_no_optuna_search.sh
#   nohup ./hymeko_neuro/experiments/wait_until_no_optuna_search.sh -- \\
#     bash hymeko_neuro/experiments/run_optuna_core_signed_graphs_serial.sh \\
...
PAT="hymeko_neuro.experiments.runs.run_optuna_search"
