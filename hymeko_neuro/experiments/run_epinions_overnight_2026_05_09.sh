...
RESULTS_FILE="hymeko_neuro/experiments/results/epinions_overnight_2026_05_09.jsonl"
...
while pgrep -f "python -m hymeko_neuro.experiments.runs.run_final_cell" \
        | grep -v "$$" | grep -q .; do
    sleep 60
done
...
p = pathlib.Path("hymeko_neuro/experiments/results/epinions_overnight_2026_05_09.jsonl")
print()
