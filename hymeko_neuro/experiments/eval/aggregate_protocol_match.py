...
:mod:`hymeko_neuro.experiments.runs.run_protocol_matched_sigat` and emits, per
...
Run:
    python -m hymeko_neuro.experiments.eval.aggregate_protocol_match \
        --in hymeko_neuro/experiments/results/protocol_matched_full.jsonl
"""
