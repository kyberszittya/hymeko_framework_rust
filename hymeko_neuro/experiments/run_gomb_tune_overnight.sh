...
#
# SOTA reference (test ROC-AUC, ``hymeko_neuro/eval/benchmarks/sota_reference.json``):
...
#
# Run from repo root:
#   nohup bash hymeko_neuro/experiments/run_gomb_tune_overnight.sh \
...
"${PY}" -m hymeko_neuro.experiments.runs.run_gomb_tune \
