...
Usage:
    python -m hymeko_neuro.experiments.run_dual_path_seq \\
...
from hymeko_neuro.experiments.sequence.dual_path_model import DualPathSequenceModel
from hymeko_neuro.experiments.sequence.synthetic_seq import SynthConfig, make_dataset
