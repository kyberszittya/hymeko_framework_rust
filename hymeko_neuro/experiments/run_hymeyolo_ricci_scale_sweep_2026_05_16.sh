...
#     hymeko_neuro/experiments/results/hymeyolo_ricci_scale_sweep_<STAMP>/
...
OUT_DIR="$REPO_ROOT/hymeko_neuro/experiments/results/hymeyolo_ricci_scale_sweep_${STAMP}"
mkdir -p "$OUT_DIR"
...
run_one() {
  ...
  local cmd=("$PY" -m hymeko_neuro.experiments.vision.train_circles_ricci
