...
:mod:`hymeko_neuro.experiments.vision.hymeyolo_warmstart`.  Uses the existing
``AdaptiveQuadtreeRust`` (variance + Forman κ curvature scored) from
:mod:`hymeko_neuro.models.hymeko_gomb.soma.vision.quadtree_rust` to
...
from hymeko_neuro.models.hymeko_gomb.soma.vision.quadtree_rust import (
