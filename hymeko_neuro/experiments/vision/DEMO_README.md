...
/home/kyberszittya/miniconda3/bin/python -m \
    hymeko_neuro.experiments.vision.demo_hymeyolo_tk
```
...
1. Train + save:
   ...
   ```bash
   ./hymeko_neuro/experiments/run_hymeyolo_ladder_5seed.sh a2
   # ... but with --save-checkpoint added to the training CLI; for
   # a quick standalone train+save, run directly:
   /home/kyberszittya/miniconda3/bin/python -m \
       hymeko_neuro.experiments.vision.train_circles_ricci \
