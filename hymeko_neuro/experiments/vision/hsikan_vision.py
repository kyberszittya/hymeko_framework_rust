...
Run:
    python -m hymeko_neuro.experiments.vision.hsikan_vision \
...
# ─── Catmull-Rom activation (lifted from hymeko_neuro.hyperedge.splines) ─
...
class CRActivation(nn.Module):
    ...
    def forward(self, x: torch.Tensor, branch_idx: int) -> torch.Tensor:
        ...
        ``hymeko_neuro/tests/test_cractivation_parity.py``.
        """
