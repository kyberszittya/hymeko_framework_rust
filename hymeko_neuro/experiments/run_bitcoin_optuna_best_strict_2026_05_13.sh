...
OUT="hymeko_neuro/experiments/results/bitcoin_optuna_best_strict_2026_05_13.jsonl"
...
# Wait for any GPU-occupying hymeko_neuro process.
echo "[strict] waiting for GPU..." | tee -a "$MASTER"
SELF_PID="$$"
while pgrep -af 'hymeko_neuro\.src\.run_optuna_search|hymeko_neuro\.src\.run_final_cell|hymeko_neuro\.src\.vision\.train' \
