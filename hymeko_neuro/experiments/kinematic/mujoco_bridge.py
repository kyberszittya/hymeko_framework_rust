...
import os
# 'egl' is a headless-Linux GL backend and an INVALID value on Windows (os.name == 'nt'), where it
# aborts `import mujoco`. Only default it off-Windows; let MuJoCo auto-pick its platform default on Windows.
if os.name != "nt":
