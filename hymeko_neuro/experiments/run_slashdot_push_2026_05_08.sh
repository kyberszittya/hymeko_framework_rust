...
RESULTS_FILE="hymeko_neuro/experiments/results/slashdot_push_2026_05_08.jsonl"
...
python - <<'PY'
import json, pathlib
p = pathlib.Path("hymeko_neuro/experiments/results/slashdot_push_2026_05_08.jsonl")
