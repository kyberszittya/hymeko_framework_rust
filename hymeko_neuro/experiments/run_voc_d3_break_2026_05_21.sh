...
OUT_DIR="hymeko_neuro/experiments/results/voc_d3_break_${STAMP}"
mkdir -p "$OUT_DIR"
...
# Queue behind any in-flight hymeko_neuro / vision training.
echo "[orch] waiting for GPU (other hymeko_neuro / vision runs)..." | tee -a "$LOG"
