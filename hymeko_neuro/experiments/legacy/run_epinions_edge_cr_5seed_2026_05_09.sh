...
RESULTS_FILE="hymeko_neuro/experiments/results/epinions_edge_cr_5seed_2026_05_09.jsonl"
...
new = pathlib.Path("hymeko_neuro/experiments/results/epinions_edge_cr_5seed_2026_05_09.jsonl")
