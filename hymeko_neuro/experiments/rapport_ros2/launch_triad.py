...
Run:
    ...
    python -m hymeko_neuro.experiments.rapport_ros2.launch_triad
...
DEFAULT_RVIZ_CONFIG = REPO_ROOT / "hymeko_neuro" / "src" / "rapport_ros2" \
    / "rviz" / "triad_hri.rviz"
...
def main(argv: list[str] | None = None) -> None:
    ...
    subprocess.run(
        [sys.executable, "-m", "hymeko_neuro.experiments.rapport_ros2.bridge_config",
    ...
    try:
        ...
        for module, settle in [
            ...
            stack.spawn(
                module,
                [sys.executable, "-m",
                 f"hymeko_neuro.experiments.rapport_ros2.{module}",
