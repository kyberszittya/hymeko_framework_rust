...
RESULTS_FILE="hymeko_neuro/experiments/results/outer_hsikan_gomb_residual_2026_05_20.jsonl"
...
run_cell() {
  ...
  systemd-run --user --scope -p MemoryMax=14G \
    ...
    python -m hymeko_neuro.experiments.runs.run_gomb_smoke \
...
base_path = pathlib.Path("hymeko_neuro/experiments/results/stacked_gomb_overnight_2026_05_20.jsonl")
base_rows = []
if base_path.exists():
...
sub_path = pathlib.Path("hymeko_neuro/experiments/results/outer_hsikan_gomb_overnight_2026_05_20.jsonl")
sub_rows = []
if sub_path.exists():
