...
python -m hymeko_neuro.experiments.chicken.simulator \
...
python -m hymeko_neuro.experiments.chicken.aggressor \
...
```bash
python -m hymeko_neuro.experiments.chicken.unsupervised \
