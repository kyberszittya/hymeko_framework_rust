...
#     bash hymeko_neuro/experiments/run_after_experiment.sh \
#     bash hymeko_neuro/experiments/run_optuna_core_signed_graphs_serial.sh \
#     >> hymeko_neuro/experiments/results/follow_optuna_$(date -u +%Y%m%dT%H%M%SZ).log 2>&1 &
#
...
LOCK="${HYMEKO_CUDA_JOB_LOCK:-${REPO}/hymeko_neuro/experiments/results/.cuda_job_serial.lock}"
