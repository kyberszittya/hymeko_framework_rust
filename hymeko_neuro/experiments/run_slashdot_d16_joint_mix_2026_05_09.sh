...
RESULTS_FILE="hymeko_neuro/experiments/results/slashdot_d16_joint_mix_2026_05_09.jsonl"
...
new  = pathlib.Path("hymeko_neuro/experiments/results/slashdot_d16_joint_mix_2026_05_09.jsonl")
