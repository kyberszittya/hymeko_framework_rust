...
#
# Launch:
#   bash hymeko_neuro/experiments/run_hsikan_rescore_and_audit_2026_05_17.sh \
...
OUT_DIR="hymeko_neuro/experiments/results/hsikan_rescore_audit_${STAMP}"
mkdir -p "$OUT_DIR"
...
echo "[orch] waiting for GPU (any hymeko_neuro training)..." | tee -a "$LOG"
while pgrep -af 'hymeko_neuro\.src\.(run_optuna_search|run_final_cell|run_gomb_smoke)' \
