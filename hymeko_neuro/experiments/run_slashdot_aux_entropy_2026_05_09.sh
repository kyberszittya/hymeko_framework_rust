...
RESULTS_FILE="hymeko_neuro/experiments/results/slashdot_aux_entropy_2026_05_09.jsonl"
...
run_cell() {
    ...
    env "$@" python -m hymeko_neuro.experiments.runs.run_final_cell \
...
new = pathlib.Path("hymeko_neuro/experiments/results/slashdot_aux_entropy_2026_05_09.jsonl")
