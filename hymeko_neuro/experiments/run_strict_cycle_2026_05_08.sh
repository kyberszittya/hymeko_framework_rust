...
RESULTS_FILE="hymeko_neuro/experiments/results/joint_mix_5seed_2026_05_08.jsonl"
...
p = pathlib.Path("hymeko_neuro/experiments/results/joint_mix_5seed_2026_05_08.jsonl")
