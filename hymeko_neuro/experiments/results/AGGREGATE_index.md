# `hymeko_neuro/experiments/results/` aggregate index
...
**Total:** 150 files (`find hymeko_neuro/experiments/results -type f`).
...
Paths relative to `hymeko_neuro/experiments/results/`.
...
```bash
find hymeko_neuro/experiments/results -type f | wc -l
find hymeko_neuro/experiments/results -type f | sed 's|.*/hymeko_neuro/experiments/results/||' | sort
find hymeko_neuro/experiments/results -name '*.jsonl' -type f -exec wc -l {} + | sort -n
```
