...
* **Default path:** ``hymeko_neuro/experiments/results/.cuda_job_serial.lock``
...
def _default_lock_path() -> Path:
    # .../hymeko_neuro/eval/benchmarks/cuda_job_lock.py → hymeko_neuro/
    hymeko_neuro = Path(__file__).resolve().parent.parent.parent
    return hymeko_neuro / "experiments" / "results" / ".cuda_job_serial.lock"
