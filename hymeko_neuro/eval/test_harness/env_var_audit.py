...
Usage:
    ...
    python -m hymeko_neuro.eval.test_harness.env_var_audit
"""
...
def _build_signedkan_layer(
    ...
    sys.path.insert(0, "hymeko_neuro")
    from hymeko_neuro.hyperedge.signedkan import SignedKANLayer, SignedKANConfig
    cfg = SignedKANConfig(
...
def _build_mixed_arity_model(
    ...
    from hymeko_neuro.models.mixed_arity_signedkan import (
...
def cases() -> list[AuditCase]:
    ...
    def _attn_dot_assertion(model) -> tuple[bool, str]:
        sys.path.insert(0, "hymeko_neuro")
        from hymeko_neuro.models.mixed_arity_signedkan import _AttentionM_e
    ...
    def _attn_q_assertion(model) -> tuple[bool, str]:
        sys.path.insert(0, "hymeko_neuro")
        from hymeko_neuro.models.mixed_arity_signedkan import _QuaternionAttentionM_e
