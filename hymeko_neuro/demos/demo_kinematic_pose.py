...
Usage:
    HSIKAN_TORCH_COMPILE=1 python -m hymeko_neuro.demos.demo_kinematic_pose
...
from hymeko_neuro.experiments.runs.run_phase11_kinematic_tasks import detect_dominant_arity
