...
``hymeko_neuro.signedkan``; the module has since moved to
``hymeko_neuro.hyperedge.signedkan`` (``demo/checkpoint.py`` warns that renames
...
_LEGACY_MODULE_ALIASES: dict[str, str] = {
    "hymeko_neuro.signedkan": "hymeko_neuro.hyperedge.signedkan",
}
