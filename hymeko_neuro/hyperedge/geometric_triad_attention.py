...
reusing ``hymeko_neuro.experiments.sequence.clifford.geometric_product``. The two carry
...
from hymeko_neuro.experiments.sequence.clifford import CL2_DIM, geometric_product
