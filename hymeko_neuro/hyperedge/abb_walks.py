...
def abb_enumerate_walks(
    ...
    *,
    ...
    :func:`hymeko_neuro.hyperedge.walks.construct_walks`).
...
def msg_enumerate_walks(
    ...
    *,
    ...
    Delegates to :class:`hymeko_neuro.hyperedge.reservoir.NumpyReservoirSampler`
    via :func:`hymeko_neuro.hyperedge.walks._python_walks_array`. Kept
