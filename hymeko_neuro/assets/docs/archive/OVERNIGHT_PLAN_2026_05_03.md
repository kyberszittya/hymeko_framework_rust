...
- `hymeko_neuro/run_phase2_mixed_arity.run_one_mixed`
...
Driver: `hymeko_neuro/run_phase8_overnight_grid.py`
Output: `hymeko_neuro/experiments/results/phase8_overnight_grid.jsonl`
...
wc -l hymeko_neuro/experiments/results/phase8_overnight_grid.jsonl

# Inspect Stage 3 results once it starts:
wc -l hymeko_neuro/experiments/results/phase9_slashdot_sota.jsonl
```
...
Driver: `hymeko_neuro/run_phase9_slashdot_sota.py`
Output: `hymeko_neuro/experiments/results/phase9_slashdot_sota.jsonl`
...
- Bitcoin SOTA result: `hymeko_neuro/experiments/results/phase8_sota_chase.jsonl`
- Bitcoin 5-seed: `/tmp/hsikan_logs/bitcoin_5seed.log`
- Slashdot λ sweep (live): `/tmp/hsikan_logs/slashdot_lambda_sweep.log`
- Overnight grid driver: `hymeko_neuro/run_phase8_overnight_grid.py`
- Overnight grid log: `/tmp/hsikan_logs/overnight_grid.log` (live)
- Overnight grid results: `hymeko_neuro/experiments/results/phase8_overnight_grid.jsonl`
