...
- `hymeko_neuro/eval/benchmarks/k4_correctness.py` — runs reference
  vs accelerated on Tier A+B, asserts invariants 1–5.
- `hymeko_neuro/eval/benchmarks/k4_speed.py` — measures wall-clock
  + memory peak across all tiers, writes a comparison JSON.
- `hymeko_neuro/eval/benchmarks/training_speed.py` — measures
