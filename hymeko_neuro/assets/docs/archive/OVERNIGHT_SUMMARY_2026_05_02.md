...
New file `hymeko_neuro/baselines/sigat_model.py`. 2-motif
...
See `hymeko_neuro/experiments/results/master_table.md`. Per-dataset
...
- `hymeko_neuro/baselines/sigat_model.py` — SiGAT-attn model
  (2-motif pos/neg, multi-head attention).
- `hymeko_neuro/run_phase8_bitcoin_5seed.py` — Bitcoin 6-arch panel.
- `hymeko_neuro/run_phase9_k345_mixed.py` — k34/k345/k45 sweep.
- `hymeko_neuro/run_phase10_master_table.py` — analysis.
- `hymeko_neuro/run_phase11_positivity_sweep.py` — pos sweep w/ k34.
- `hymeko_neuro/run_phase11b_k45_positivity.py` — pos sweep w/ k45.
- `hymeko_neuro/n_tuples.py` — Rust fast-path.
- `hymeko_neuro/run_phase2_mixed_arity.py` — `max_per_arity` dict.
