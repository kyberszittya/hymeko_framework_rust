...
**Where it lives.** §III.7 of `hymeko_neuro/assets/paper/sections/03_signedkan.tex`,
...
`hymeko_neuro/assets/paper/sections/04_experiments.tex` collects the
