...
#
# Usage:
#   bash hymeko_neuro/assets/scripts/run_overnight_camera_ready.sh
#
# Output:
...
OUT_FILE="hymeko_neuro/experiments/results/overnight_camera_ready.jsonl"
LOG_FILE="hymeko_neuro/experiments/results/overnight_camera_ready.log"
...
run_cell() {
  ...
  local result
  if result=$(timeout 7200 python3 -m hymeko_neuro.experiments.runs.run_final_cell $args 2>&1 | tail -1); then
