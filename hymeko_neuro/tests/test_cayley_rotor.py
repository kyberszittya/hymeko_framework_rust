"""Tests for the Cayley-rotor embedding (hymeko_neuro/graph/embeddings/cayley_rotor.py).

Run: pytest -p no:randomly hymeko_neuro/tests/test_cayley_rotor.py
"""
...
from hymeko_neuro.graph.embeddings.cayley_rotor import (
