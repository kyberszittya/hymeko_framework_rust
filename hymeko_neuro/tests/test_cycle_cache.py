"""Tests for ``hymeko_neuro.graph.cycle_cache``.
...
from hymeko_neuro.hyperedge.n_tuples import SignedNTuple
...
def test_cached_construct_walks_resolves_walks_module():
    ...
    ``hymeko_neuro.hyperedge.walks``, not a non-existent ``cycle_cache.walks``.
