...
def test_class_head_no_no_object_slot():
    ...
    from hymeko_neuro.experiments.vision.nodelet_head import make_nodelet_class_head
...
def test_gate_head_emits_one_logit_per_query():
    from hymeko_neuro.experiments.vision.nodelet_head import make_nodelet_gate_head
...
def test_gated_loss_basic_runs():
    from hymeko_neuro.experiments.vision.nodelet_head import hungarian_set_loss_gated
    B, N, n_classes = 2, 4, 3
    M_max = 2
...
def test_filter_keeps_only_above_threshold():
    from hymeko_neuro.experiments.vision.nodelet_head import filter_predictions_by_gate
