...
``hymeko_neuro.kernels.triton_kernels``.
...
Run:
    pytest hymeko_neuro/tests/test_triton_kernels.py -v -s
...
def test_catmull_rom_parity(C, G, B):
    ...
    from hymeko_neuro.kernels.triton_kernels import catmull_rom_triton
...
def test_signedkan_inner_parity(V, d, T, k, G):
    ...
    from hymeko_neuro.kernels.triton_kernels import signedkan_inner_triton
...
def test_catmull_rom_autograd_grad_parity():
    ...
    from hymeko_neuro.hyperedge.splines import _catmull_rom_eval
    from hymeko_neuro.kernels.triton_kernels import catmull_rom_triton_autograd
...
def test_end_to_end_ba_smoke_with_patch():
    ...
    def run_ba(use_triton: bool) -> float:
        ...
        from hymeko_neuro.experiments.runs.run_final_cell import cell_signed_graph
