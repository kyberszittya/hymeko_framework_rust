...
def test_backbone_builds_and_has_expected_shape():
    from hymeko_neuro.experiments.vision.hymeyolo_backbones import build_backbone
...
def test_rejects_non_rgb_input_channels():
    from hymeko_neuro.experiments.vision.hymeyolo_backbones import ResNet18ImageNetBackbone
