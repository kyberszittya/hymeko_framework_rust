...
Run:
    pytest hymeko_neuro/tests/test_pipeline_integrity.py -v
...
from hymeko_neuro.eval.test_harness.env_var_audit import cases as audit_cases
from hymeko_neuro.eval.test_harness.env_var_audit import _env_block
from hymeko_neuro.eval.test_harness.invariant_check import smoke_test
