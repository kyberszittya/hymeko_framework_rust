...
5-seed scripts under `hymeko_neuro/experiments/`.

Run:
    pytest hymeko_neuro/tests/test_sota_smoke.py -v
"""
...
from hymeko_neuro.models.hymeko_gomb import GombConfig, HymeKoGomb
