...
from hymeko_neuro.experiments.demo.kinematic import (
    KinematicBundle, find_urdf_by_id, load_urdf_bundle,
    load_urdf_registry,
)
from hymeko_neuro.experiments.demo.kinematic_classifier import (
...
def test_save_load_roundtrip(tmp_path):
    ...
    from hymeko_neuro.experiments.runs.run_phase11_kinematic_tasks import GraphLevelHSiKAN
...
@pytest.mark.skipif(not PRETRAINED_PRESENT,
                     reason="pretrained classifiers not present "
                            "(run: python -m hymeko_neuro.experiments.demo.kinematic_classifier)")
