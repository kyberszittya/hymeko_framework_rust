...
def test_sigma_three_positive_is_one():
    from hymeko_neuro.experiments.rapport.coherence import sigma_cycle
    from hymeko_neuro.experiments.rapport.coalition import SigmaCycle
...
def test_estimator_positive_observations_drive_weight_toward_plus_one():
    from hymeko_neuro.experiments.rapport.coalition import load_coalition
    from hymeko_neuro.experiments.rapport.estimator import CoalitionEstimator, Observation
...
def test_simulator_emits_observations_at_baseline():
    from hymeko_neuro.experiments.rapport.coalition import load_coalition
    from hymeko_neuro.experiments.rapport.simulator import (
...
def test_simulator_conflict_scenario_drives_sigma_negative():
    ...
    from hymeko_neuro.experiments.rapport.coalition import load_coalition
    from hymeko_neuro.experiments.rapport.estimator import CoalitionEstimator
    from hymeko_neuro.experiments.rapport.coherence import sigma_cycle
    from hymeko_neuro.experiments.rapport.simulator import (
