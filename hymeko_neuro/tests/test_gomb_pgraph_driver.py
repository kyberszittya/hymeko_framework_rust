...
from hymeko_neuro.experiments.gomb_pgraph_mapping import merge_structure_knobs
from hymeko_neuro.hymeko.hymeko_driver import parse_training, run_single_gomb
...
def test_hymeko_driver_gomb_sweep_one_cell():
    ...
    cmd = [
        sys.executable,
        "-m",
        "hymeko_neuro.hymeko.hymeko_driver",
        "--backend",
        "gomb",
        "--sweep",
...
def test_run_gomb_msg_sweep_msg_phase_only():
    ...
    cmd = [
        sys.executable,
        "-m",
        "hymeko_neuro.experiments.runs.run_gomb_msg_sweep",
        "--pgraph",
