...
def test_imdb_classifier_forward_shape():
    from hymeko_neuro.experiments.sequence.text_classifier import IMDBClassifier
    torch.manual_seed(0)
...
def test_tokenize_strips_html_and_lowercases():
    from hymeko_neuro.experiments.sequence.imdb_dataset import tokenize
...
def test_build_imdb_vocab_deterministic_tie_breaking(tmp_path):
    ...
    from hymeko_neuro.experiments.sequence.imdb_dataset import (
