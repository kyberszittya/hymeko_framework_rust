...
def test_rgb_to_hsv_pure_red():
    from hymeko_neuro.experiments.rapport_ros2.vision_sidecar_node import rgb_image_to_hsv
...
def test_detect_human_blobs_finds_blue_patch():
    ...
    from hymeko_neuro.experiments.rapport_ros2.vision_sidecar_node import detect_human_blobs
