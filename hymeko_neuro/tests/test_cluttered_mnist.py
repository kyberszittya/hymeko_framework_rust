...
from hymeko_neuro.experiments.vision.cluttered_mnist import ClutteredMNIST, ClutteredSample, collate_cluttered
...
def test_iou_constraint(ds):
    ...
    from hymeko_neuro.experiments.vision.cluttered_mnist import ClutteredMNIST as CM
    for i in range(16):
        s = ds[i]
