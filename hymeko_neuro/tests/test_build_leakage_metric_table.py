"""Tests for the leakage-metric table builder (hymeko_neuro/paperkit/build_leakage_metric_table)."""
from __future__ import annotations

import importlib

m = importlib.import_module("hymeko_neuro.paperkit.build_leakage_metric_table")
