...
def test_lazy_cycle_pool_roundtrips_smoke(tmp_path, monkeypatch):
    ...
    from hymeko_neuro.graph.cycle_cache import LazyCyclePool, _save_packed
...
def test_lazy_cycle_pool_missing_path_returns_none(tmp_path):
    from hymeko_neuro.graph.cycle_cache import LazyCyclePool
...
def test_cache_format_roundtrip(tmp_path, monkeypatch, fmt):
    ...
    from hymeko_neuro.graph.cycle_cache import _load_packed, _save_packed
...
def test_cbor_smaller_than_npz_on_tiny_payload(tmp_path, monkeypatch):
    ...
    claim."""
    from hymeko_neuro.graph.cycle_cache import _save_packed
