...
from hymeko_neuro.experiments.sequence.clifford import CL2_DIM, geometric_product, multivector_norm
from hymeko_neuro.experiments.sequence.clifford_positional import (
    CliffordRotorPositional, _rotor_apply,
)
from hymeko_neuro.experiments.sequence.text_embedding import TokenMultivectorEmbedding
from hymeko_neuro.experiments.sequence.cross_dual_path import CrossDualPathBlock
from hymeko_neuro.experiments.sequence.encoder_decoder import DualPathEncoderDecoder
from hymeko_neuro.experiments.sequence.synthetic_seq2seq import (
