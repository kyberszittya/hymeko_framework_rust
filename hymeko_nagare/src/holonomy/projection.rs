...
use crate::ops::project_alpha_mix::{ProjectAlphaMixShape, project_alpha_mix_forward};

use super::features::{GEOMETRY_CHANNELS, HOLONOMY_CHANNELS, ROTOR_CHANNELS, VERTEX_FEATURES};
use super::pooling::STRUCTURAL_FEATURES;

/// Maximum number of retained basis directions.
pub const PROJECTION_RANK: usize = 6;

/// Mixing weight of the projected component (`alpha * P(x) + (1-alpha) * x`).
