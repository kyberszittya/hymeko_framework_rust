...
//! loss `L = sum(grad_y ⊙ y)` through `project_alpha_mix_forward`.

use hymeko_nagare::holonomy::{PROJECTION_ALPHA, default_holonomy_basis};
use hymeko_nagare::{ProjectAlphaMixShape, project_alpha_mix_backward, project_alpha_mix_forward};
