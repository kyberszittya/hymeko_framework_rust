...
- ✅ Gömb-strict link prediction across Bitcoin/OTC/Slashdot/Epinions/wiki_elec (~0.90–0.94 AUC, config-dependent; leakage control → 0.540 = chance); ~30k params — artifacts under `hymeko_neuro/experiments/results/*.jsonl`, `reports/gomb_tune_*`, `reports/hsikan_*5seed*`
