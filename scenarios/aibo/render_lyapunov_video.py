...
def rollout(env, V, *, pursue: bool):
    ...
    ``_STRIDE`` steps; the certificate is evaluated on the full V-series.
    """
    import mujoco
...
def main() -> None:
    ...
    imageio.mimsave(_OUT / "aibo_lyapunov_compare.gif", composed[::2], fps=_FPS // 2)
