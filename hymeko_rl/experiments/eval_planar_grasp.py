...
with error bars rather than an anecdote).
    ...
    uv run python -m hymeko_rl.experiments.eval_planar_grasp --checkpoint checkpoints/galambos/ppo_strategy.pt -n 100
"""
...
from hymeko_rl.eval.evaluate import evaluate
from hymeko_rl.viz.render_planar_gifs import load_policy, policy_action_fn
