...
output answers "where did HSiKAN break?" — a NAMED structural component — which an MLP cannot tell you.
    ...
    python -m hymeko_rl.experiments.exp_diagnose_divergence --seed 2 --refine 20000
"""
...
from hymeko_rl.experiments.hsikan_diagnose import diagnose, format_diagnosis, plot_diagnosis
