...
from hymeko_rl.control.hypergraph_designs import k_uniform_random, steiner_triple_system, sunflower  # noqa: E402
from hymeko_rl.experiments.structural_probe import build_chain_graph  # noqa: E402
...
def figure_results(*, seeds: int = 2, epochs: int = 180) -> Path:
    from hymeko_rl.agents.structural_actor import run_structural_actor_probe
    gens = [
