...
or ``mp4`` (imageio; a CORE.YAML §1 dependency, inert until approved + installed).
    ...
    python -m hymeko_rl.viz.render_reach --source expert --encoder gif --out reports/reach
    python -m hymeko_rl.viz.render_reach --source bc --encoder mp4 --out reports/reach  # needs imageio
"""
...
from hymeko_rl.train.bc import _make_policy, behaviour_clone, collect_demos
...
from hymeko_rl.eval.evaluate import _stamp_frames, now_stamp
from hymeko_rl.agents.policy import ActorCritic
