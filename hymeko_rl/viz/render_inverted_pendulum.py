...
stored tensor shapes*, so the artifact is self-sufficient — no separate config.
    ...
    python -m hymeko_rl.viz.render_inverted_pendulum --policy data/nn/cartpole_hsikan_policy.hymeko --out reports/gifs/cartpole
"""
...
from hymeko_rl.agents.policy_store import hymeko_to_policy, read_provenance
from hymeko_rl.train.train_inverted_pendulum import GreedyPolicy
