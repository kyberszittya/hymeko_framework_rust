"""Train a robot policy: reaching via behaviour cloning (Phase 1) or PPO (Phase 2).
    ...
    python -m hymeko_rl.train.train_robot_rl --task reach-bc  --policy hsikan
    python -m hymeko_rl.train.train_robot_rl --task reach-ppo --policy hsikan
    python -m hymeko_rl.train.train_robot_rl --task reach-ppo --policy mlp     # the ablation baseline
...
from hymeko_rl.train.ppo import PPOConfig, run_ppo
