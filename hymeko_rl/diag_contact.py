...
from hymeko_rl.campaign_viz import _greedy_action_fn
from hymeko_rl.exp_pernode_actor_ab import _build_actor, match_mlp_hidden
from hymeko_rl.sac import SACConfig, train_sac
...
def main(argv: "list[str] | None" = None) -> int:
    ...
    def env_factory() -> object:
        ...
        if a.design == "kuniform":
            from hymeko_rl.exp_designed_control import DesignAugmentedEnv
            from hymeko_rl.hypergraph_designs import k_uniform_blocks
