...
spec ``data/robotics/galambos_spec.htl`` (:class:`hymeko_rl.htl_reward.HtlRewardSpec`). The comparable
...
train loop, no re-implemented rendering (CLAUDE.md §6.1/§6.5#3).
    ...
    python -m hymeko_rl.exp_htl_reward_ab --mode smoke   # short, 1 seed — proves plumbing + 3-form output
    python -m hymeko_rl.exp_htl_reward_ab --mode full    # longer single seed
"""
...
from hymeko_rl.htl_reward import HtlRewardSpec
from hymeko_rl.offpolicy_eval import _env_dims
