...
:func:`hymeko_rl.policy.mlp_backbone`.
"""
...
from hymeko_rl.policy import mlp_backbone
...
class _ReadoutBackbone(nn.Module):
    ...
    The attention scorer mirrors :meth:`hymeko_rl.structural_critic.StructuralCritic._pool` (§6.1 — same pattern)."""
