...
_HAVE_BANK = os.path.isfile("experiments/2026_07_18_arcrl/c1_heldseed_bank.pkl")
...
@pytest.mark.skipif(not _HAVE_BANK, reason="c1_heldseed_bank.pkl is a gitignored external artifact (absent in a clone)")
