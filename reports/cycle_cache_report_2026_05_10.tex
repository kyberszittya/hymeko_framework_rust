...
# hymeko_neuro/graph/cycle_cache.py
...
python -m hymeko_neuro.run_final_cell --dataset epinions \
    --hidden 4 --n-epochs 80 --max-k4 100000 --seed 0

# Cached path — identical AUC distribution, ~5x speedup across seeds.
HYMEKO_CYCLE_CACHE=1 python -m hymeko_neuro.run_final_cell \
...
bash hymeko_neuro/experiments/run_epinions_balance_5seed_2026_05_10.sh
