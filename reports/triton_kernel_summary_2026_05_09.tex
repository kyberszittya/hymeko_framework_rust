...
HSIKAN_TRITON_KERNEL=1 python -m pytest hymeko_neuro/tests/test_triton_kernels.py -v

# Reproduce the kernel-OFF Slashdot 5-seed (~90 min)
bash hymeko_neuro/experiments/run_slashdot_edge_cr_5seed_2026_05_09.sh

# Reproduce the kernel-ON Slashdot 5-seed (~66 min, this paper)
bash hymeko_neuro/experiments/run_slashdot_edge_cr_kernel_on_2026_05_09.sh
