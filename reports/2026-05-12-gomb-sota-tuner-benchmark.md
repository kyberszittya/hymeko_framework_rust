...
- **`hymeko_neuro/experiments/gomb_jsonl_summarize.py`**: prints a Markdown table from `tuner_phase_summary` rows.
...
`PYTHONPATH=. python -m hymeko_neuro.run_gomb_tune --datasets bitcoin_alpha --joint-mix --trials 6 --search-seed 99 --data-seed 0 --edge-split 80_10_10 --n-epochs 56 --device cuda --pick-best-by val_auroc --out reports/gomb_tune_sota_chase_alpha_joint_2026_05_12.jsonl`
...
Driver: **`hymeko_neuro/experiments/run_gomb_wide_param_sweep.sh`**
