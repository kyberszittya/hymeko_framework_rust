...
`signedkan_wip/src/paperkit/build_leakage_metric_table.py` (matches the figure-builder
...
`cycle_reachability_grid.jsonl` (60). Emits to `signedkan_wip/paper/tables/`:
...
- `pytest signedkan_wip/tests/test_build_leakage_metric_table.py` — **5 passed** (L/Δ
...
**None.** `signedkan_wip` + `paper/tables` (non-core).
