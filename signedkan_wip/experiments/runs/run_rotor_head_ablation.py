...
the same q?
    ...
    python -m signedkan_wip.experiments.runs.run_rotor_head_ablation \
...
from signedkan_wip.src.baselines.cayley_rotor_baseline import _structural_features
from signedkan_wip.src.core.bilinear_head import BilinearHead, ComplexDiagonalHead
