...
Usage:
    PYTHONPATH=$PWD python -m signedkan_wip.experiments.runs.probe_hsikan_tier1 [--mode {baseline,compile,amp,compile_amp}]
"""
...
from signedkan_wip.src.vision.vision_bench_cell import build_model, load_split
