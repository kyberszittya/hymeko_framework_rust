...
Covers `signedkan_wip.src.vision.demo_hymeyolo_core`:
...
from signedkan_wip.src.vision import demo_hymeyolo_core as core
...
def test_tk_module_reexports_core_functions():
    ...
    from signedkan_wip.src.vision import demo_hymeyolo_tk as gui
