...
Run: ``pytest -p no:randomly signedkan_wip/tests/test_build_leakage_source_figure.py``
"""
...
from signedkan_wip.src.paperkit import build_leakage_source_figure as mod
from signedkan_wip.src.paperkit.build_leakage_source_figure import (
    Arm,
