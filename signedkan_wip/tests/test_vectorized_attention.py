...
Run: ``pytest -p no:randomly signedkan_wip/tests/test_vectorized_attention.py``
"""
...
from signedkan_wip.src.baselines._attention import build_csr, segment_attention
