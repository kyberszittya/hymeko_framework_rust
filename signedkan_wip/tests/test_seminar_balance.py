...
need the built ``hymeko`` engine and skip without it. Run via the venv::
    ...
    PYTHONPATH=. .venv/Scripts/python.exe -m pytest -p no:randomly \
        signedkan_wip/tests/test_seminar_balance.py
"""
...
from signedkan_wip.demos.seminar.demos.balance import (
...
def test_balance_statistics_camps_is_one() -> None:
    from signedkan_wip.demos.seminar.demos.balance import balance_statistics
