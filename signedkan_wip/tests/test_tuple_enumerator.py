...
Added 2026-06-03 alongside ``signedkan_wip/src/cycle_cache/strategies.py``.
Verifies:
...
def test_walks_subsample_in_numpy_space():
    ...
    from signedkan_wip.src.core.walks import construct_walks_arrays
    g = _toy_graph()
...
def test_walks_arrays_match_legacy_classification_semantics():
    ...
    identical."""
    from signedkan_wip.src.core.walks import (
