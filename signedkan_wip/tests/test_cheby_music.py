...
from signedkan_wip.examples.cheby_music import (
    KICK,
    LFO,
    ChebyshevSequencer,
    Pooling,
...
from signedkan_wip.examples.cheby_music.midi import vlq
...
def test_formant_filter_reshapes_spectrum() -> None:
    ...
    from signedkan_wip.examples.cheby_music.synth import FORMANTS, Formant
...
def test_sidechain_env_dips_at_kicks_and_recovers() -> None:
    ...
    from signedkan_wip.examples.cheby_music.synth import _sidechain_env
    sr = 48000
