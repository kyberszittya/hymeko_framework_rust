...
Added 2026-06-03 alongside ``signedkan_wip/src/core/reservoir.py``
...
from signedkan_wip.src.core.reservoir import (
...
def test_python_walks_respects_max_walks():
    ...
    from signedkan_wip.src.core.walks import _python_walks
    g = _toy_dense_graph()
...
def test_enumerate_k_cycles_respects_max_cycles():
    ...
    from signedkan_wip.src.core.n_tuples import enumerate_k_cycles
    g = _toy_dense_graph()
