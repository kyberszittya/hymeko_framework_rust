...
The PyTorch reference at signedkan_wip/src/sequence/clifford_fir.py
...
def clifford_fir_forward_triton(
    ...
    Same semantics as ``signedkan_wip.src.sequence.clifford_fir.CliffordFIR
...
class _CliffordFIRAutograd(torch.autograd.Function):
    ...
    def backward(ctx, grad_y: torch.Tensor):
        ...
        from signedkan_wip.src.sequence.clifford import geometric_product
