...
Quick smoke (CPU OK for small synthetic graphs):
    python -m signedkan_wip.src.run_synthetic_baseline \\
        --generator easy_sbm --n-epochs 30
    HSIKAN_SPARSE_ATTN_K=8 python -m signedkan_wip.src.run_synthetic_baseline \\
...
from .synthetic_signed_graphs import GENERATORS
