...
class CycleEnumerator(TupleEnumerator):
    ...
    def enumerate(self, g, *, seed: int) -> EnumeratedArrays:
        from ..core.n_tuples import construct_k_arrays
...
class WalkEnumerator(TupleEnumerator):
    ...
    def enumerate(self, g, *, seed: int) -> EnumeratedArrays:
        from ..core.walks import construct_walks_arrays
...
class SSGWalkEnumerator(TupleEnumerator):
    ...
    def enumerate(self, g, *, seed: int) -> EnumeratedArrays:
        from ..core.abb_walks import ssg_pareto_filter
        from ..core.path_scorers import pick_scorer
...
def _walks_sigma_from_edge_signs(
    ...
    :func:`signedkan_wip.src.core.walks._classify_walks_arrays`.
    """
...
class TwoCycleEnumerator(TupleEnumerator):
    ...
    def enumerate(self, g, *, seed: int) -> EnumeratedArrays:
        from ..core.n_tuples import construct_2_arrays
...
_STRATEGY_FACTORIES: dict[str, Any] = {
    ...
    # acceleration. See :mod:`signedkan_wip.src.core.path_scorers` and
    # :mod:`signedkan_wip.src.core.abb_walks`.
