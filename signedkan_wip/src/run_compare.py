...
Run:
    python -m signedkan_wip.src.run_compare \\
...
from .baselines.vanilla_kan import VanillaKAN
...
from .n_tuple_loss import (NTupleBalanceLoss, NTupleBalanceLossConfig,
                            build_ntuple_balance_tensors)
from .signed_laplacian import make_spectral_init
from .cross_branch_reg import CrossBranchRegulariser, CrossBranchRegConfig
from .attention import (SignedTriadAttention, attention_entropy_loss,
