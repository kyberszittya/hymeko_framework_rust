...
Running:
    HSIKAN_TORCH_COMPILE=1 python -m signedkan_wip.src.run_multi_domain_perf_bench
...
from .datasets import SignedGraph, load, deduplicate_pairs, split
from .datasets_small import sbm_signed, hierarchical_signed
